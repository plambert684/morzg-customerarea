                    ...
                    <div class="row g-2 align-items-center">
                        <div class="col">
                            ...
                            <div class="page-pretitle">
                                <?=$langData["overviewPage"]["pre-title"]?>
                            </div>
                            <h2 class="page-title">
                                <?=$langData["overviewPage"]["title"]?>
                            </h2>
                        </div>
                        <!-- Page title actions -->
                ...
                <div class="container-xl">
                    <div class="row row-deck row-cards">
                            ...
                            <div class="card card-md">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-10">
                                            <h3 class="h1"><?=$langData["overviewPage"]["eco-designed-title"]?></h3>
                                            <div class="markdown text-muted">
                                                <?=$langData["overviewPage"]["eco-designed-desc"]?>
                                            </div>
                                            <div class="mt-3">
                                                <a href="" class="btn btn-success" target="_blank" rel="noopener"><?=$langData["overviewPage"]["eco-designed-button"]?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="text-muted">
                                                        <?=$langData["overviewPage"]["stats"]["services"]["title"]?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="text-muted">
                                                        <?=$langData["overviewPage"]["stats"]["orders"]["title"]?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="text-muted">
                                                        <?=$langData["overviewPage"]["stats"]["tickets"]["title"]?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="text-muted">
                                                        <?=$langData["overviewPage"]["stats"]["invoices"]["title"]?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title"><?=$langData["overviewPage"]["active-services"]["title"]?></h3>
                                    <div class="table-responsive">
                                        <table class="table table-vcenter">
                                            <thead>
                                            <tr>
                                                <th><?=$langData["overviewPage"]["active-services"]["tables"]["service"]?></th>
                                                <th><?=$langData["overviewPage"]["active-services"]["tables"]["order_date"]?></th>
                                                <th><?=$langData["overviewPage"]["active-services"]["tables"]["due_date"]?></th>
                                                <th class="w-1"></th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            ...
                                            <div class="row">
                                                ...
                                                foreach ($getProductCategories as $getProductCategory) {?>
                                                    <div class="col-auto d-flex align-items-center px-2">
                                                        <span class="legend me-2 bg-<?=$getProductCategory->color?>"></span>
                                                        <span><?=$getProductCategory->name?></span>
...
<?php require('views/layouts/DashboardLayout.php') ?>